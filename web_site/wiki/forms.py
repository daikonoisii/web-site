...
class SortForm(forms.Form):
    ...
    sort1 = forms.MultipleChoiceField(
          label=_("a2"),
          required=True,
          disabled=False,
          initial=["1"],
...
class CreateRootForm(forms.Form):
    ...
    content = forms.CharField(
        ...
        help_text=_("root articleの概要を記載. どのコンテンツに関する記事か"),
