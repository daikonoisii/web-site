...
class WikiSite:
    ...
    def __init__(self, name='wiki'):
        from .views import accounts, article, deleted_list, category
        ...
        self.software_view = getattr(self, "software_view", category.SoftwareListView.as_view())
        self.labtips_view = getattr(self, "labtips_view", category.LabTipsListView.as_view())
        self.schoollifetips_view = getattr(self, "schoollifetips_view", category.SchoolLifeTipsListView.as_view())
        self.server_view = getattr(self, "server_view", category.ServerListView.as_view())
        self.etcetera_view = getattr(self, "etcetera_view", category.EtceteraListView.as_view())
    ...
    def get_urls(self):
        ...
        urlpatterns += self.get_category_urls()
    ...
    def get_category_urls(self):
        urlpatterns = [\
                re_path('software_list/',\
                    self.software_view, name='software'),\
                re_path('server_list/',\
                    self.server_view, name='server'),\
                re_path('lab_tips_list/',\
                    self.labtips_view, name='lab_tips'),\
                re_path('schoollife_tips_list/',\
                    self.schoollifetips_view, name='schoollife_tips'),\
                re_path('etcetera_list/',\
                    self.etcetera_view, name='etcetera'),\
                    #category.EtceteraListView, name='etcetera'),\
            ]
        return urlpatterns
