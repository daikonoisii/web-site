...
from .views import category, accounts, article, deleted_list
...
class WikiURLPatterns:
    ...
    def get_category_urls(self):
        ...
        urlpatterns = [\
                re_path(r'^software_list/$',\
                    category.SoftwareListView.as_view(), name='software'),\
                re_path(r'^server_list/',\
                    category.ServerListView.as_view(), name='server'),\
                re_path(r'^lab_tips_list/',\
                    category.LabTipsListView.as_view(), name='lab_tips'),\
                re_path(r'^schoollife_tips_list/',\
                    category.SchoolLifeTipsListView.as_view(), name='schoollife_tips'),\
                re_path(r'^etcetera_list/',\
                    category.EtceteraListView.as_view(), name='etcetera'),\
